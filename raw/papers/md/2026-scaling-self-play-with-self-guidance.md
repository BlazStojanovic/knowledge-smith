...
Authors:[Luke Bailey](https://arxiv.org/search/cs?searchtype=author&query=Bailey,+L), [Kaiyue Wen](https://arxiv.org/search/cs?searchtype=author&query=Wen,+K), [Kefan Dong](https://arxiv.org/search/cs?searchtype=author&query=Dong,+K), [Tatsunori Hashimoto](https://arxiv.org/search/cs?searchtype=author&query=Hashimoto,+T), [Tengyu Ma](https://arxiv.org/search/cs?searchtype=author&query=Ma,+T)

View a PDF of the paper titled Scaling Self-Play with Self-Guidance, by Luke Bailey and 4 other authors

[View PDF](/pdf/2604.20209)
[HTML (experimental)](https://arxiv.org/html/2604.20209v1)
...
| Cite as: | [arXiv:2604.20209](https://arxiv.org/abs/2604.20209) [cs.LG] |
|  | (or  [arXiv:2604.20209v1](https://arxiv.org/abs/2604.20209v1) [cs.LG] for this version) |
|  | <https://doi.org/10.48550/arXiv.2604.20209> Focus to learn more  arXiv-issued DOI via DataCite (pending registration) |

## Submission history

From: Luke Bailey [[view email](/show-email/dedf397c/2604.20209)]   
 **[v1]**
Wed, 22 Apr 2026 05:50:23 UTC (877 KB)
...
[< prev](/prevnext?id=2604.20209&function=prev&context=cs.LG "previous in cs.LG (accesskey p)")
  |   
[next >](/prevnext?id=2604.20209&function=next&context=cs.LG "next in cs.LG (accesskey n)")

[new](/list/cs.LG/new)
 | 
[recent](/list/cs.LG/recent)
 | [2026-04](/list/cs.LG/2026-04)

Change to browse by:

[cs](/abs/2604.20209?context=cs)

### References & Citations

* [NASA ADS](https://ui.adsabs.harvard.edu/abs/arXiv:2604.20209)
* [Google Scholar](https://scholar.google.com/scholar_lookup?arxiv_id=2604.20209)
* [Semantic Scholar](https://api.semanticscholar.org/arXiv:2604.20209)
...
[Which authors of this paper are endorsers?](/auth/show-endorsers/2604.20209) |
